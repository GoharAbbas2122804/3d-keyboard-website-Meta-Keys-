...
const KeyBoardColorSelector: FC<KeyBoardColorSelectorProps> = ({ slice }) => {
  ...
  const [selectesTextureId, setSelectedTextureId] = useState(KEYCAP_TEXTURES[0].id);
  ...
  return (
    ...
    >
      ...
      <Canvas camera={{position: [0,.5, .5 ], fov:45 , zoom:1.5}} className="-mb-[10vh] grow">
        <Scene  selectedTextureId={selectesTextureId}  onAnimationComplete={handleAnimationComplete}/>
      </Canvas>
